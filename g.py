...
TOKEN = '8218323814:AAFsH5caQYzE0xjitCsaeFV9g2N4NPj4cEE' #Enter_Bot_Token_within_the_colons
MONGO_URI = 'mongodb+srv://Bishal:Bishal@bishal.dffybpx.mongodb.net/?retryWrites=true&w=majority&appName=Bishal'
FORWARD_CHANNEL_ID = -1001987596149

ADMIN_ID = 7510439132  # Added admin user ID   
...
def is_user_admin(user_id, chat_id):
    if user_id == ADMIN_ID:  # Always allow the owner
        return True
    try:
...
def handle_message(message):
    ...
    if message.text == "Stop Attack 🧡":
        ...
        bot.reply_to(message, "*Heya Master_-_\n\n Join @MADDOXOWNER on Telegram*", parse_mode='Markdown')
    elif message.text == "Contact admin✔️":
        bot.reply_to(message, "*My Admins Are*\n\n @MADDOXOWNER", parse_mode='Markdown')
    else:
